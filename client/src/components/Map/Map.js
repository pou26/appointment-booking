    ...
    return (
        <div>
            ...
            <div className="mapwrap">
                ...
                <section className="img-wrap">
                    <div className="img col-lg-4 col-md-12 mb-4 mb-lg-0">
                        <img
                            ...
                            className="img-containerr w-100 shadow-1-strong rounded mb-4"
                            alt="CT Scan & X-Ray"
                ...
                <div className="gmap">
                    <iframe width="600px" height="600px" id="gmap_canvas" src="https://maps.google.com/maps?q=altius hospital bangalore&t=&z=11&ie=UTF8&iwloc=&output=embed" scrolling="yes" ></iframe>
                </div>
            </div>
