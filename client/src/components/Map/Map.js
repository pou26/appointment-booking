        ...
        <div>
            ...
            <div className="mapwrap">
                ...
                <section className="img-wrap">
                    <div className="img1 col-lg-4 col-md-12 mb-4 mb-lg-0">
                        <img
                            src="https://altiushospital.com/wp-content/uploads/2021/02/Aryabhata-International-Award.jpg"
                            className="img-containerr shadow-1-strong rounded mb-4"
                            alt="CT Scan & X-Ray"
                    ...
                    <div className="img1 col-lg-4 mb-4 mb-lg-0">
                        <img
                ...
                <div className="gmap">
                    <iframe width="500px" height="500px" id="gmap_canvas" src="https://maps.google.com/maps?q=altius hospital bangalore&t=&z=11&ie=UTF8&iwloc=&output=embed" scrolling="yes" ></iframe>
                </div>
            </div>
